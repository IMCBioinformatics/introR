...
You can download the file directly from dropbox using [this link](https://www.dropbox.com/sh/pegir6j09mq7sia/AACQO9BnNAEl4EofAhmyqjmXa?dl=0). Remember to put this file in a directory that makes sense (ex. in your RStudio Project directory in a `data` directory). 
