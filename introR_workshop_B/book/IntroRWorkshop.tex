...
\hypersetup{
  ...
  pdfauthor={Sahar Bagheri, Ewandson L. Lameu},
  hidelinks,
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2333}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.6333}}@{}}
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0980}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9020}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Column
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{head}\NormalTok{(clean}\SpecialCharTok{$}\NormalTok{BP)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{IntroRWorkshop_files/figure-latex/unnamed-chunk-125-1.pdf}
...
\includegraphics{IntroRWorkshop_files/figure-latex/unnamed-chunk-126-1.pdf}
...
\includegraphics{IntroRWorkshop_files/figure-latex/unnamed-chunk-129-1.pdf}
...
\includegraphics{IntroRWorkshop_files/figure-latex/unnamed-chunk-131-1.pdf}
